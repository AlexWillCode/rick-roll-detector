...
You can scan an image file using the [verify_image](api.md#rick_roll_detectorverify_imageimage-numpyarray-bool) function.
...
Now let's use the [verify_image](api.md#rick_roll_detectorverify_imageimage-numpyarray-bool) function.
```python
